...
class ActividadRepository() : IActividadRepository {
    ...
    override fun obtenerPorId(id: Int): Actividad? = actividades.find { it.obtenerId() == id }
    ...
    override fun obtenerEventosEntreFechas(
        inicio: String,
        fin: String,
    ): List<Evento> =
        actividades
    ...
    override fun contarTareasConSubtareas(): Int = 0
}
